export default function Terms() {
  return (
    <main className="bg-blue-50 p-5 w-full justify-center flex">
      <div className="sm:max-w-xl md:max-w-2xl gap-5 flex flex-col">
        ...
        <div class="flex flex-col gap-2">
          ...
          <p>
            ...
            Do <strong>NOT</strong> continue to use Quizal if you do not agree
        ...
        <div class="flex flex-col gap-2">
          ...
          <p>
            Unless otherwise stated, Quizal and/or its licensors own the
            intellectual property rights for all material on Quizal. All
            intellectual property rights are reserved. You may access this from
            Quizal for your own personal use subjected to restrictions set in
        ...
        <div class="flex flex-col gap-2">
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Quizal; and
          ...
          <p>
            ...
            are interested in linking to our App, you must inform us by sending
            an e-mail to Quizal. Please include your name, your organization
            name, contact information as well as the URL of your site, a list of
            any URLs from which you intend to link to our App, and a list of the
            URLs on our site to which you would like to link. Wait 2-3 weeks for
            a response.
          </p>
